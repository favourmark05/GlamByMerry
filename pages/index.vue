  ...
  <no-ssr>
   <section class="dashboard">
      ...
      <!--<div class="row">-->
        ...
        <!--</div>-->
        <!--<div class="col-lg-8">-->
          <!--&lt;!&ndash;work progress start&ndash;&gt;-->
          <!--<section class="card">-->
            ...
            <!--</table>-->
          <!--</section>-->
          <!--&lt;!&ndash;work progress end&ndash;&gt;-->
        <!--</div>-->
      <!--</div>-->
      <!--<div class="row">-->
        <!--<div class="col-lg-8">-->
          <!--&lt;!&ndash;timeline start&ndash;&gt;-->
          <!--<section class="card">-->
            <!--<div class="card-body">-->
            ...
            <!--</div>-->
          <!--</section>-->
          <!--&lt;!&ndash;timeline end&ndash;&gt;-->
        <!--</div>-->
        <!--<div class="col-lg-4">-->
          <!--&lt;!&ndash;revenue start&ndash;&gt;-->
          <!--<section class="card">-->
            ...
            <!--</div>-->
          <!--</section>-->
          <!--&lt;!&ndash;revenue end&ndash;&gt;-->
          <!--&lt;!&ndash;features carousel start&ndash;&gt;-->
          <!--<section class="card">-->
            ...
            <!--</div>-->
          <!--</section>-->
          <!--&lt;!&ndash;features carousel end&ndash;&gt;-->
        <!--</div>-->
      <!--</div>-->
      <!--<div class="row">-->
        <!--<div class="col-lg-8">-->
          <!--&lt;!&ndash;latest product info start&ndash;&gt;-->
          <!--<section class="card post-wrap pro-box">-->
            ...
            <!--</aside>-->
          <!--</section>-->
          <!--&lt;!&ndash;latest product info end&ndash;&gt;-->
          <!--&lt;!&ndash;twitter feedback start&ndash;&gt;-->
          <!--<section class="card post-wrap pro-box">-->
            ...
            <!--</aside>-->
          <!--</section>-->
          <!--&lt;!&ndash;twitter feedback end&ndash;&gt;-->
        <!--</div>-->
        <!--<div class="col-lg-4">-->
          <!--<div class="row">-->
            <!--<div class="col-6">-->
              <!--&lt;!&ndash;pie chart start&ndash;&gt;-->
              <!--<section class="card">-->
                <!--<div class="card-body">-->
                  <!--<div class="chart">-->
            ...
            <!--<div class="col-6">-->
              ...
              <!--<section class="card">-->
                ...
                <!--</footer>-->
              <!--</section>-->
              <!--&lt;!&ndash;follower end&ndash;&gt;-->
            <!--</div>-->
          <!--</div>-->
          <!--&lt;!&ndash;weather statement start&ndash;&gt;-->
          <!--<section class="card">-->
          ...
          <!--</section>-->
          <!--&lt;!&ndash;weather statement end&ndash;&gt;-->
        <!--</div>-->
      <!--</div>-->
