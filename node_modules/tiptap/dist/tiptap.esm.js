...
import { getMarkRange, markIsActive, getMarkAttrs, nodeIsActive } from 'tiptap-utils';
import Vue from 'vue';
...
function (_Emitter) {
  ...
  _createClass(Editor, [{
    ...
    value: function focus() {
      ...
      var selection = TextSelection.near(this.view.state.doc.resolve(pos));
    ...
    value: function setActiveNodesAndMarks() {
      ...
      this.activeMarkAttrs = Object.entries(this.schema.marks).reduce(function (marks, _ref4) {
        ...
        return _objectSpread({}, marks, _defineProperty({}, name, getMarkAttrs(_this7.state, mark)));
      }, {});
