...
function (_Emitter) {
  ...
  _createClass(Editor, [{
    ...
    value: function focus() {
      ...
      var selection = prosemirrorState.TextSelection.near(this.view.state.doc.resolve(pos));
      var transaction = this.view.state.tr.setSelection(selection);
      this.view.dispatch(transaction);
      setTimeout(function () {
        _this6.view.focus();
      }, 10);
    ...
    value: function setContent() {
      ...
      var newState = prosemirrorState.EditorState.create({
    ...
    value: function setActiveNodesAndMarks() {
      ...
      this.activeMarkAttrs = Object.entries(this.schema.marks).reduce(function (marks, _ref4) {
        ...
        return _objectSpread({}, marks, _defineProperty({}, name, tiptapUtils.getMarkAttrs(_this7.state, mark)));
      }, {});
